...
namespace OpenSim.Region.PhysicsModule.BulletS
{
    ...
    // =====================================================================
    internal enum VehRotationParam
    {
        ReferenceFrame,
    }
    ...
    // =====================================================================
    internal enum LegionVehicleType
    {
        None = 0,
        Sled = 1,
        Car = 2,
    ...
    // =====================================================================
    [Flags]
    internal enum LegionVehicleFlags
    {
        None                = 0,
        NoDeflectionUp      = 1,
        LimitRollOnly       = 2,
    ...
    /// </summary>
    internal class LegionVehicleProperties
    {
